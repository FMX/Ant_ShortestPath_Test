...
public class Parse {
	...
	static int parse_commandline(String args[]) {
		...
		options.addOption("i", "tsplibfile", true,
				"f inputfile (TSPLIB format necessary)");
		...
		if (cmd.hasOption("h")) {
			...
			formatter.printHelp(InOut.PROG_ID_STR
		...
		if (cmd.hasOption("i")) {
			...
			System.out.println("-i/tsplibfile File with argument "
					+ InOut.name_buf);
		} else {
		...
		if (cmd.hasOption("l")) {
			...
			case 0:
				System.out
						.println("Note: local search flag is set to default 0 (disabled)");
				break;
			case 1:
				System.out
						.println("Note: local search flag is set to default 1 (2-opt)");
				break;
			case 2:
				System.out
						.println("Note: local search flag is set to default 2 (2.5-opt)");
				break;
			case 3:
				System.out
						.println("Note: local search flag is set to default 3 (3-opt)");
				break;
			default:
				System.out.println("-l/localsearch with argument "
						+ LocalSearch.ls_flag);
				break;
			}
		}
		...
		if (cmd.hasOption("k")) {
			...
			System.out
					.println("-k/nnls Number nearest neighbours with argument "
							+ LocalSearch.nn_ls);
		} else {
			System.out
					.println("Note: Number nearest neighbours in local search is set to default "
							+ LocalSearch.nn_ls);
		}
